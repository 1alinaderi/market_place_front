  ...
  async function onSubmit1(e) {
    ...
    if (seller) {
      await httpReauest(
        ...
        { email: inputEmail, code: inputCode },
        {}
      )
        .then((e) => {
          console.log(e);
    ...
    <div className="w-full px-5 py-6 mx-auto rounded-lg sm:p-8 bg-brand-light sm:w-96 md:w-450px">
      ...
      <div className="text-center mb-9 pt-2.5">
        ...
        <p className="mt-3 mb-8 text-sm md:text-base text-body sm:mt-4 sm:mb-10">
          {code
            ? t('common:forgot-password-helper-1')
      ...
      {code ? (
        <form onSubmit={onSubmit1} noValidate>
          <input
            className="w-full mb-4 appearance-none border border-slate-300 leading-tight focus:outline-none focus:shadow-outline h-[50px] rounded "
            type="text"
            name="code"
            onChange={(e) => {
