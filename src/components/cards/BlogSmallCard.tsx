  ...
  return (
    <div className="w-full rounded-[15px] p-[10px] bg-white flex gap-4 border-2 border-[#ffffff]">
      ...
      <span className=" flex flex-col gap-2 justify-between items-start ">
        <h5
          style={{ color: '#000' }}
          className="leading-7 line-clamp-2 lg:text-[16px] text-[12px]"
        >
          {data?.name}
        </h5>

        <Link href={'/news/' + data?.url}>
          <button className="btn-brand-2 py-2 border-2 border-[#ffbbbb] text-[#000] px-4 text-[14px] flex items-center gap-2 rounded-[16px] font-bold">
